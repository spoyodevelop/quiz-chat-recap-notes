...
const TILBoard: React.FC<TILBoardProps> = ({
  sessions,
  onStartNew,
  onSessionSelect,
}) => {
    ...
    <div className="max-w-6xl mx-auto">
      ...
      {sessions.length === 0 ? (
        <div className="text-center py-16">
          ...
          <p className="text-gray-400 mb-6">첫 번째 TIL을 만들어보세요!</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          {sessions.map((session, index) => (
            <Card
              key={session.id}
              className="group hover:shadow-lg transition-all duration-300 hover:-translate-y-1 border-0 overflow-hidden cursor-pointer"
